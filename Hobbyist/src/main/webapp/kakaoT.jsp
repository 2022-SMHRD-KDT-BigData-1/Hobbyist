   ...
   <div id="wrapper">
      ...
      <div id="main">
         ...
         <div id="category_wrapper_wrapper">
            ...
            <form action="Tmap.jsp" method="post">
            <div class="category_wraper">
               <span>현재 위치입니다.</span>
               <input type="hidden" value=value1 class="start1">
               <input type="hidden" value=value2 class="end1">
                          ...
                          // 결과값으로 받은 위치를 마커로 표시합니다
                             ...
                             geocoder.addressSearch(value2,function(result, status) {
                                 ...
                                 // 결과값으로 받은 위치를 마커로 표시합니다
                                    ...
                                    localStorage.setItem('end',coords2);
                                    
                                    console.log("start" + start);
                                    console.log("end" + end);             
                                    
                                    location.href = "Tmap.jsp?start="+start+"&end="+end;
