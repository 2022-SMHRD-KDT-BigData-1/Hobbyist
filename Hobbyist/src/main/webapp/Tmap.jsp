...
<body onload="initTmap();">
		...
		<div id="main">
			<div class="inner">
				...
				<input type="hidden" value="<%=x%>" class="value1"> <input
					type="hidden" value="<%=y%>" class="value2">
	...
	<script type="text/javascript">
		...
		//경로안내 요청 함수
		function getRP() {
			var s_latlng = new Tmapv2.LatLng(35.13170315360063,
					126.8950838844395);
			var e_latlng = new Tmapv2.LatLng(35.15004370097252,
					126.91980824040856);
		...
		function onComplete() {
			...
			map
					.setCenter(new Tmapv2.LatLng(35.14087342728658,
							126.907446062424));
			map.setZoom(14);
		}
